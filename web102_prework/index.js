...
function addGamesToPage(games) {
    ...
    for(const game of games) {
        ...
        gameCard.innerHTML =` <img src="${game.img}" alt="${game.name}" style="width: 300px;"/>
            <h3>${game.name}</h3></>
...
const displayStr = 
  `A total of $${totalPledged.toLocaleString()} has been raised for ${totalGames} ${totalGames === 1 ? 'game' : 'games'}. Currently, 
  ${numberOfUnfundedGames} ${numberOfUnfundedGames === 1 ? 'game remains' : 'games remain'} unfunded. 
